...
#         dict[index] = "POI" + str(index) + " is " + dict[index]
#     for index in range(17,21):
#         dict[index]="OD"+str(index-16)+" is "+dict[index]
#     # change word to 4 OD only 2017-04-21
#     result_data.update({"words":dict[17:21]})
#     documents.append(result_data)

# 2.5 change the poi content from poi_martix.josn
documents=[]
for tmp in data:
    result_data={}
    dict = tmp.split(',')
